-- Update get_owner_active_rentals to use normalized lowercase status values
-- This ensures consistency after the status normalization migration
...
BEGIN
  ...
  AND r.status IN ('active', 'approved', 'returned')  -- Updated to use lowercase
