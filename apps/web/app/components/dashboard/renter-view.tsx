...
export function RenterDashboardView() {
    ...
    // ⚡ Bolt Optimization: Use useMemo with a single reduce loop instead of multiple filters
    // This reduces O(N*2) array traversals to O(N) when calculating derived counts
    const { urgentCount, overdueCount } = useMemo(() => {
        return activeRentals.reduce((acc, r) => {
