...
export function RenterDashboardView() {
    ...
    // ⚡ Bolt Optimization: Use useMemo with a single O(N) reduction to pre-calculate multiple counts
    // instead of performing separate .filter(...).length passes on every render.
