    ...
    useEffect(() => {
        const fetchSuggestions = async () => {
            ...
            if (type === 'category' && categories) {
                ...
                // Optimization: The 'categories' array is already sorted alphabetically from useMarketplace.
                // We do an O(N) pass to partition into 'startsWith' matches and 'includes' matches,
                // preserving the original alphabetical order without expensive localeCompare sort.
