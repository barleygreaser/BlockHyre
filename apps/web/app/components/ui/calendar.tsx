...
import { DayButton, DayPicker, getDefaultClassNames, DateRange, Matcher } from "react-day-picker"
...
export type CalendarProps = React.ComponentProps<typeof DayPicker> & {
    blockedDates?: Date[];
    minDate?: Date | null;
    selected?: any; // Widened type to accommodate different modes
    onSelect?: any; // Widened type
}
...
function Calendar({
    ...
    const handleSelect = (
        ...
        // Collision detection for Range mode
        if (mode === "range" && rangeOrDate) {
            ...
            if (range?.from && range?.to) {
                ...
                const hasCollision = blockedDates.some((blockedDate) => {
                    ...
                    // Check if blocked date is strictly strictly between start and end
        ...
        if (onSelect) {
            onSelect(rangeOrDate, selectedDay, activeModifiers, e);
        }
    }

    // Prepare disabled matchers
