...
export default function TransactionsPage() {
    ...
    // ⚡ Bolt Optimization: Calculate payout counts with a single O(N) array traversal inside useMemo.
    // This avoids multiple .filter(...).length passes on every render, resolving O(3N) overhead.
