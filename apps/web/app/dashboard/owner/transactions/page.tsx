...
export default function TransactionsPage() {
    ...
    // ⚡ Bolt Optimization: Memoize derived filtered list to avoid O(N) traversal on every render
    ...
    // This avoids executing three separate O(N) .filter().length operations on every render.
