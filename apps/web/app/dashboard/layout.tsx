        ...
        <AuthGuard>
            <DashboardProvider>
                <div className="flex min-h-screen bg-slate-50 font-sans">
                    ...
                    {/* Sidebar — reads activeRole directly from DashboardContext, no Suspense needed */}
                    <DashboardSidebar />
                    ...
                    */}
                    <main className="flex-1 lg:ml-64 pt-14 lg:pt-6 p-4 lg:p-8 overflow-x-hidden relative z-20">
