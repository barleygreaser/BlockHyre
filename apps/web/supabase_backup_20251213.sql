...
CREATE OR REPLACE FUNCTION "public"."mark_messages_read"("p_chat_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."mark_messages_read"("p_chat_id" "uuid") OWNER TO "postgres";


COMMENT ON FUNCTION "public"."mark_messages_read"("p_chat_id" "uuid") IS 'Marks all unread messages in a chat as read for the current user';
...
CREATE OR REPLACE FUNCTION "public"."upsert_conversation"("p_listing_id" "uuid", "p_renter_id" "uuid") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $_$
DECLARE
    v_owner_id uuid;
...
BEGIN
    -- Get listing owner and details using ACTUAL column names from listings table
...
ALTER FUNCTION "public"."upsert_conversation"("p_listing_id" "uuid", "p_renter_id" "uuid") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."category_specifications" (
...
CREATE TABLE IF NOT EXISTS "public"."listings" (
    ...
    CONSTRAINT "check_listing_status" CHECK (("status" = ANY (ARRAY['active'::"text", 'draft'::"text", 'archived'::"text"]))),
    CONSTRAINT "check_manual_url_domain" CHECK ((("manual_url" IS NULL) OR ("manual_url" ~~ 'https://www.manualslib.com%'::"text")))
);
...
CREATE TABLE IF NOT EXISTS "public"."messages" (
    ...
    CONSTRAINT "messages_type_check" CHECK (("message_type" = ANY (ARRAY['text'::"text", 'system'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."system_message_templates" (
    ...
    "description" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "sends_external_alert" boolean DEFAULT false NOT NULL,
    "alert_type" "text"
);


ALTER TABLE "public"."system_message_templates" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."category_specifications"
    ADD CONSTRAINT "category_specifications_pkey" PRIMARY KEY ("category_id", "spec_id");



ALTER TABLE ONLY "public"."category_specs"
    ADD CONSTRAINT "category_specs_pkey" PRIMARY KEY ("category_id", "spec_id");
...
ALTER TABLE ONLY "public"."listing_specifications"
    ADD CONSTRAINT "listing_specifications_spec_key_key" UNIQUE ("spec_key");
...
ALTER TABLE ONLY "public"."system_message_templates"
    ADD CONSTRAINT "system_message_templates_event_name_key" UNIQUE ("event_name");



ALTER TABLE ONLY "public"."system_message_templates"
    ADD CONSTRAINT "system_message_templates_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."chats"
    ADD CONSTRAINT "unique_tool_owner_renter" UNIQUE ("listing_id", "owner_id", "renter_id");
...
CREATE INDEX "idx_chats_owner_id" ON "public"."chats" USING "btree" ("owner_id");



CREATE INDEX "idx_chats_renter_id" ON "public"."chats" USING "btree" ("renter_id");
...
CREATE UNIQUE INDEX "idx_system_message_templates_event_name" ON "public"."system_message_templates" USING "btree" ("event_name");
...
ALTER TABLE ONLY "public"."category_specifications"
    ADD CONSTRAINT "category_specifications_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "public"."categories"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."category_specifications"
    ADD CONSTRAINT "category_specifications_spec_id_fkey" FOREIGN KEY ("spec_id") REFERENCES "public"."listing_specifications"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."category_specs"
    ADD CONSTRAINT "category_specs_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "public"."categories"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."category_specs"
    ADD CONSTRAINT "category_specs_spec_id_fkey" FOREIGN KEY ("spec_id") REFERENCES "public"."listing_specifications"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."chats"
    ADD CONSTRAINT "chats_renter_id_fkey" FOREIGN KEY ("renter_id") REFERENCES "public"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."chats"
    ADD CONSTRAINT "chats_user_one_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."chats"
    ADD CONSTRAINT "chats_user_two_id_fkey" FOREIGN KEY ("renter_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;
...
CREATE POLICY "Category links are viewable by everyone" ON "public"."category_specs" FOR SELECT USING (true);



CREATE POLICY "Category specs are viewable by everyone" ON "public"."category_specifications" FOR SELECT USING (true);
...
CREATE POLICY "Specifications are viewable by everyone" ON "public"."listing_specifications" FOR SELECT USING (true);
...
CREATE POLICY "Users can create a new chat" ON "public"."chats" FOR INSERT WITH CHECK ((("auth"."uid"() = "owner_id") OR ("auth"."uid"() = "renter_id")));



CREATE POLICY "Users can create chats where they are owner or renter" ON "public"."chats" FOR INSERT WITH CHECK ((("auth"."uid"() = "owner_id") OR ("auth"."uid"() = "renter_id")));
...
CREATE POLICY "Users can mark messages as read" ON "public"."messages" FOR UPDATE USING (((EXISTS ( SELECT 1
   FROM "public"."chats"
  WHERE (("chats"."id" = "messages"."chat_id") AND (("chats"."owner_id" = "auth"."uid"()) OR ("chats"."renter_id" = "auth"."uid"()))))) AND ("sender_id" <> "auth"."uid"()))) WITH CHECK (("is_read" = true));



CREATE POLICY "Users can send messages into their chats" ON "public"."messages" FOR INSERT WITH CHECK ((("sender_id" = "auth"."uid"()) AND (EXISTS ( SELECT 1
   FROM "public"."chats"
  WHERE (("chats"."id" = "messages"."chat_id") AND (("chats"."owner_id" = "auth"."uid"()) OR ("chats"."renter_id" = "auth"."uid"())))))));



CREATE POLICY "Users can send messages to their chats" ON "public"."messages" FOR INSERT WITH CHECK ((("auth"."uid"() = "sender_id") AND (EXISTS ( SELECT 1
   FROM "public"."chats"
  WHERE (("chats"."id" = "messages"."chat_id") AND (("chats"."owner_id" = "auth"."uid"()) OR ("chats"."renter_id" = "auth"."uid"())))))));



CREATE POLICY "Users can update message read status" ON "public"."messages" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."chats"
  WHERE (("chats"."id" = "messages"."chat_id") AND (("chats"."owner_id" = "auth"."uid"()) OR ("chats"."renter_id" = "auth"."uid"())))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."chats"
  WHERE (("chats"."id" = "messages"."chat_id") AND (("chats"."owner_id" = "auth"."uid"()) OR ("chats"."renter_id" = "auth"."uid"()))))));
...
CREATE POLICY "Users can view chats where they are owner or renter" ON "public"."chats" FOR SELECT USING ((("auth"."uid"() = "owner_id") OR ("auth"."uid"() = "renter_id")));
...
ALTER TABLE "public"."category_specifications" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON FUNCTION "public"."mark_messages_read"("p_chat_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."mark_messages_read"("p_chat_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."mark_messages_read"("p_chat_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."upsert_conversation"("p_listing_id" "uuid", "p_renter_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."upsert_conversation"("p_listing_id" "uuid", "p_renter_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."upsert_conversation"("p_listing_id" "uuid", "p_renter_id" "uuid") TO "service_role";
...
GRANT ALL ON TABLE "public"."category_specifications" TO "anon";
GRANT ALL ON TABLE "public"."category_specifications" TO "authenticated";
GRANT ALL ON TABLE "public"."category_specifications" TO "service_role";



GRANT ALL ON TABLE "public"."category_specs" TO "anon";
GRANT ALL ON TABLE "public"."category_specs" TO "authenticated";
GRANT ALL ON TABLE "public"."category_specs" TO "service_role";
...
GRANT ALL ON TABLE "public"."system_message_templates" TO "anon";
GRANT ALL ON TABLE "public"."system_message_templates" TO "authenticated";
GRANT ALL ON TABLE "public"."system_message_templates" TO "service_role";
