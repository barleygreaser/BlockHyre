-- Fix: Cast template_body to JSONB before extracting content
-- The column might be TEXT, so we need explicit casting
...
BEGIN
    ...
    IF v_chat_id IS NOT NULL THEN
        ...
        -- Cast to jsonb first if needed
        SELECT (template_body::jsonb)->>'content' INTO v_template_content
