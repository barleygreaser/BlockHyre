-- Update search_nearby_listings to include owner rating data
...
BEGIN
  ...
  SELECT 
    ...
    l.is_high_powered,
    l.booking_type,
    COALESCE(u.average_rating, 0.00) AS owner_average_rating,
    COALESCE(u.review_count, 0) AS owner_review_count
