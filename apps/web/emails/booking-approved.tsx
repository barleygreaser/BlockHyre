...
export const BookingApprovedEmail = ({
    ...
    startDate = "today",
    endDate = "tomorrow",
    dashboardUrl = `${baseUrl}/my-rentals`,
}: BookingApprovedEmailProps) => (
    <Html>
        <Head />
        <Preview>Your rental for {toolName} was approved!</Preview>
        <Body style={main}>
            <Container style={container}>
                ...
                <Section style={content}>
                    ...
                    <Text style={text}>
                        <strong>{ownerName}</strong> has approved your rental request for the <strong>{toolName}</strong>. 
                    </Text>

                    <Text style={text}>
                        Coordinate your pickup time via the messaging system. Don't forget to take handover photos when you pick it up!
                    </Text>
...
const logoText = {
    color: '#10B981', // Emerald green to indicate approval/success
    fontSize: '24px',
